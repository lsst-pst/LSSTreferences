...
\begin{abstract}
This document provides information about technology papers that describe LSST infrastructure.
...
The LSST Project Publication Policy can be obtained from XXX.

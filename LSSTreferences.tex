...
\item LSST Sky Brightness Model: \cite{2016SPIE.9910E..1AY}
\item Simulated Observatory Control System (SOCS): \cite{2016SPIE.9911E..25R}
\end{itemize}
%------------------------------------------------------------------------------
...
\begin{itemize}
   ...
   \item LSST Scheduler from design to construction: \cite{2016SPIE.9910E..13D}
\end{itemize}
%------------------------------------------------------------------------------
